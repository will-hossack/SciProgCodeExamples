"""
   ...
   Note the THREE methods of removing the extra newline characters at the end of lines.
...
def main():
    ...
    #  Here ia an even better way, the .strip() removes "white space" at the ennd of
    #  the string, so any spaces and/or new line, this is the machine independ way to do this.
    for line in inputData:
        print(line.strip())
